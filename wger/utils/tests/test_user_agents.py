...
class AmazonUserAgentTestCase(WorkoutManagerTestCase):
    ...
    def test_user_agent_1st_generation(self):
        ...
        agent = "Mozilla/5.0 (Linux; U; Android 2.3.4; <locale>; Kindle Fire \
                Build/GINGERBREAD) AppleWebKit/<webkit> (KHTML, like Gecko) \
    ...
    def test_user_agent_generic_android(self):
        ...
        agent = "Mozilla/5.0 (Linux; U; Android <version>; <locale>; \
                ...
                Version/4.0 Safari/<safari> AmazonWebAppPlatform/"\
                "<version>"
        self.assertTrue(user_agents.is_amazon_webview(agent))
    ...
    def test_user_agent_old_ua(self):
        ...
        agent = "Mozilla/5.0 (Linux; U; Android 4.1.1; en-gb; Build/KLP)\
                AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0\
                 Safari/534.30 WgerAndroidWebApp"
