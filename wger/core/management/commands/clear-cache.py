...
class Command(BaseCommand):
    ...
    help = 'Clears the application cache. You *must* \
        pass an option selecting what exactly you want \
        to clear. See available options.'
            ...
            for user in User.objects.all():
                ...
                for entry in WorkoutLog.objects.filter(
                    ...
                    for month in WorkoutLog.objects.filter(
                        ...
                        reset_workout_log(
                            user.id, entry.year, entry.month)
