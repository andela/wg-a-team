...
class Workout(models.Model):
    ...
    comment = models.CharField(
        verbose_name=_('Description'), max_length=100, blank=True, help_text=_(
    ...
    def get_current_workout(self, user):
        ...
        try:
            ...
            if schedule.schedulestep_set.count():
                # The schedule might exist and have steps, but if it's
                # too far in the past is kind of wrong, but lets us
                # continue to the correct place
...
class Schedule(models.Model):
    ...
    name = models.CharField(
        verbose_name=_('Name'), max_length=100, help_text=_(
    ...
    is_active = models.BooleanField(
        verbose_name=_('Schedule active'), default=True, help_text=_(
    ...
    def get_current_scheduled_workout(self):
        ...
        while not found:
            ...
            # If it's not a loop, there's no workout that matches,
            # return
            if not self.is_loop:
                return False
...
class Day(models.Model):
    ...
    description = models.CharField(
        max_length=100, verbose_name=_('Description'), help_text=_(
    ...
    def get_first_day_id(self):
        '''
        Return the PK of the first day of the week, this is
        used in the template to order the days in the template
        '''
    ...
    def canonical_representation(self):
        ...
        This is extracted from the workout representation
        because that one is cached and this isn't.
        '''
    ...
    def get_canonical_representation(self):
        ...
        for set_obj in self.set_set.select_related():
            ...
            for exercise in set_obj.exercises.select_related():
                ...
                # Flag indicating whether any of the settings has
                # saved weight
                has_weight = False
...
class WorkoutSession(models.Model):
    ...
    notes = models.TextField(
        ...
        blank=True,
        help_text=_(
            'Any notes you might want to save about this workout '
            'session.'))
    '''
