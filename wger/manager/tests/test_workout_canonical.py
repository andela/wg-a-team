...
class WorkoutCanonicalFormTestCase(WorkoutManagerTestCase):
    ...
    def test_canonical_form(self):
        ...
        self.assertEqual(
            workout.canonical_representation['muscles'],
            {
                ...
                'front': [1]})
        self.assertEqual(
            workout.canonical_representation['obj'],
            workout)
            ...
            'set_list': [
                {
                    ...
                    'obj': Set.objects.get(
                        pk=2)}]}
        self.assertEqual(
            workout.canonical_representation['day_list'][1],
            canonical_form)
        ...
        canonical_form = {
            ...
            'set_list': []}
        self.assertEqual(
            workout.canonical_representation['day_list'][2],
            canonical_form)
    ...
    def test_canonical_form_day(self):
        ...
        self.assertEqual(day.canonical_representation['muscles'], {'back': [
            2], 'frontsecondary': [1], 'backsecondary': [1], 'front': []})
        ...
        self.assertEqual(
            day.canonical_representation['set_list'],
            canonical_form)
...
class WorkoutCacheTestCase(WorkoutManagerTestCase):
    ...
    def test_canonical_form_cache(self):
        ...
        self.assertFalse(
            cache.get(
                cache_mapper.get_workout_canonical(1)))
